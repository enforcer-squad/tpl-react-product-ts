...
const setStaleData = (cacheKeys: Array<string | number>, status: boolean) => setData([MANAGEMENT, ...cacheKeys, ...STALESTATE], status);

const setSnapshotData = (cacheKeys: Array<string | number>, status: any) => setData([MANAGEMENT, ...cacheKeys, SNAPSHOT], status);
